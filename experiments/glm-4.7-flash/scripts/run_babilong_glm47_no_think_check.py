...
def main():
    ...
    parser.add_argument('--model', default='glm-4.7-flash:latest')
    parser.add_argument('--num-predict', type=int, default=24)
    parser.add_argument('--num-ctx', type=int, default=24576)
    parser.add_argument('--out-dir', default='/home/himura_shiro/Projects/BabiLong/experiments/glm-4.7-flash/results')
    parser.add_argument(
        '--run-id',
        default=None,

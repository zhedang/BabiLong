...
def main():
    ...
    parser.add_argument('--out-dir', default='/home/himura_shiro/Projects/BabiLong/experiments/qwen3.5-122b/results')
    parser.add_argument(
        '--run-id',
        default=None,
    ...
    with pred_path.open('a', encoding='utf-8') as wf:
        ...
        for s in samples:
            ...
            thinking = None
            try:
                pred, thinking = qwen_chat_no_think(
